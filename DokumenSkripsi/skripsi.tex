...
\newcommand{\tanggal}[3]{
	...
	\IfStrEqCase{#2}{%ubah angka bulan menjadi kata
		...
		{1}{\renewcommand{\vbulanlc}{Januari}}		{2}{\renewcommand{vbulanlc}{Februari}}	
		{3}{\renewcommand{\vbulanlc}{Maret}}		{4}{\renewcommand{vbulanlc}{April}}	
		{5}{\renewcommand{\vbulanlc}{Mei}}			{6}{\renewcommand{vbulanlc}{Juni}}		
		{7}{\renewcommand{\vbulanlc}{Juli}}			{8}{\renewcommand{vbulanlc}{Agustus}}	
		{9}{\renewcommand{\vbulanlc}{September}}	{10}{\renewcommand{vbulanlc}{Oktober}}
		{11}{\renewcommand{\vbulanlc}{November}}	{12}{\renewcommand{vbulanlc}{Desember}}
	[]}
}
